...
$bow           '//\\\' $reset
$bow           //  \\\ $name     Advent of Code 2017 $reset
...
$tree      /$led2'$tree..$led1'$tree$led4'$tree..$led2'$tree.$led1'$tree.$led2'$tree.\ $name Advent of Code 2017 $reset
...
$suit        |     |     | $reset
$suit        ({$boots}.-.{$suit} / \\ {$boots}.-.{$suit}) $name Advent of Code 2017 $reset
...
SANTA;
	...
	function getAsciiHeader($colour = true) {
		echo (rand(0,2) == 0 ? getSanta($colour) : (rand(0,1) ? getWreath($colour) : getTree($colour)));
	}
